...
/**
 * Painel "Gerar" do Modo Mestre — antigo modal Geradores.jsx, movido para cá
 * (ver App.jsx/Inicio.jsx) e sem a moldura de modal: agora é só mais uma aba
 * dentro de ModoMestre.jsx, que trata do cabeçalho/navegação à volta.
 */
