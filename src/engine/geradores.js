...
export function gerarAmeaca({ vd = 20, arquetipo = null, tamanho = null } = {}) {
  ...
  return {
    ...
    sentidos: { percepcao: `${e.dadosTeste}O+${e.bonusTeste}`, iniciativa: `${e.dadosTeste}O+${e.bonusTeste}` },
    resistencias: arq.resistencias(),
    testes: {
      fortitude: `${e.dadosTeste}O+${e.bonusTeste}`,
      reflexos: `${e.dadosTeste}O+${Math.max(0, e.bonusTeste - 5)}`,
      vontade: `${e.dadosTeste}O+${e.bonusTeste}`,
    },
    pericias,
    ataque: {
      nome: arq.ataque.nome,
      teste: `${e.dadosTeste}O+${e.bonusTeste}`,
      dados: e.dadosTeste,
      bonus: e.bonusTeste,
